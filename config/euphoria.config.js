window.CLIENT_CONFIG = {
  client: {
    id: "euphoria",
    name: "Espaco Euphoria",
    shortName: "Euphoria",
    timezone: "America/Sao_Paulo"
  },

  branding: {
    appName: "Reserva Euphoria",
    pageTitle: "Espaco Euphoria | Reserva de Quadras",
    installPageTitle: "Instalar app | Espaco Euphoria",
    appleAppTitle: "Espaco Euphoria",
    themeColor: "#245c4f",
    logoPath: "images/perfil637.jpg",
    logoAlt: "Logo do Espaco Euphoria",
  ...
  admin: {
    ...
    authStorageKey: "euphoria-admin-auth"
  },

  storage: {
    reservationsKey: "euphoria-reservas-local",
    blocksKey: "euphoria-bloqueios-local",
    configCacheKey: "euphoria-admin-settings",
    lastContactKey: "euphoria-last-booking-contact"
  },

  texts: {
    heroEyebrow: "Espaco Euphoria",
    heroTitle: "Reserve sua quadra online.",
    heroCopy: "Consulte horarios, escolha a quadra e envie sua solicitacao em poucos passos.",
    adminHeroEyebrow: "Espaco Euphoria • Administracao",
